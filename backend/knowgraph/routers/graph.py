...
@router.get("/edge/{start_uri}/{end_uri}")
...
@router.delete("/edge/{start_uri}/{end_uri}/{relationship_type}")
...
@router.get("/paths/{start_uri}/{end_uri}")
