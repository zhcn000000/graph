...
import { findPaths, getNeighbors, getVertex, traverseGraph } from "@/api/graph";
...
export const fetchVertexInfo = createAsyncThunk("graph/vertexInfo", async (uri: string, { rejectWithValue }) => {
  try {
